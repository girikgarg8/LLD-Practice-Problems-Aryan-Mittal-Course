...
public class BallDetails {
    ...
    public void startBallDelivery(Team battingTeam, Team bowlingTeam, OverDetails over) {
        ...
        // THROW BALL AND GET THE BALL TYPE, assuming here that the ball type is always NORMAL
    ...
    private RunType getRunType() {
        ...
        else if (val >=0.3 && val <= 0.5) return RunType.TWO;
        else if (val >= 0.6 && val <= 0.8) return RunType.FOUR;
        return RunType.SIX;
    }
